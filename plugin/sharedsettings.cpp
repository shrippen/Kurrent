...
const SharedSettings::KeySpec *SharedSettings::specs()
{
    static const KeySpec keys[] = {
        ...
        {"swimlaneTimeBucket", ValueType::String, QStringLiteral("week")},
        {"swimlaneHorizon", ValueType::Int, 0},
